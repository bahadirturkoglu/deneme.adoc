  ...
  if(button_sol == 0 && button_sag == 0)
  	  {
  		 ...
  		 // kirmizi ledi yak
  		 GPIO_PORTD_DATA_R |= 0b00010;
  		GPIO_PORTD_DATA_R &= ~(0b01100);
  		GPIO_PORTD_DATA_R &= ~(0b00100);
  	 }
  else if (button_sol == 0) { // button basili ise mavi ledi yak
  		 GPIO_PORTD_DATA_R |= 0b00100;
  		GPIO_PORTD_DATA_R &= ~(0b00010);// 0x02// 0b01000
  		GPIO_PORTD_DATA_R &= ~(0b01000);// 0x02
  	 }
